...
const AdminMenu = () => {
  ...
  <NavLink to="/dashboard/admin/createproduct" className="list-group-item list-group-item-action">Create Products</NavLink>
  <NavLink to="/dashboard/admin/products" className="list-group-item list-group-item-action">Products</NavLink>
  <NavLink to="/dashboard/admin/getorders" className="list-group-item list-group-item-action">Orders</NavLink>
